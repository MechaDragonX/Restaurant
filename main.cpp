...
static std::array<Dish, 10> MENU {
    ...
    Dish("Spaghetti with Eggplant Parmigiana", 10.0, "Spaghetti servered with eggplants fried and baked in parmesan"),
    ...
    Dish("Tiramisu", 5.0, "A single slice of a coffee-flavored Italian dessert made of ladyfingers dipped in coffee and layered in a whipped mixture of eggs, sugar, and mascarpone cheese; with plenty of cocoa powder on top."),
